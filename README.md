...
# TrobotScout
TrobotScout is based on TigerScout and we incorporated the changes to support TBA integrations for match data and to provide pre-fill on pre-scout information when scouting a match.
